...
export const SALVAGE_CATALOG: readonly SalvageItemDef[] = [
  ...
  {
    id: 'salvage_rotwood_sap',
    name: 'Rotwood Sap',
    description: 'Slow amber — smells like regret.',
    sellPrice: 34,
    minMob: 17,
    weight: 2,
  },
  {
    id: 'salvage_drowned_coin',
    name: 'Drowned Coin',
    description: 'Face rubbed smooth by tide.',
    sellPrice: 38,
    minMob: 19,
    weight: 2,
  },
  {
    id: 'salvage_ember_cinder',
    name: 'Packed Cinder',
    description: 'Still clicks when tapped.',
    sellPrice: 42,
    minMob: 21,
    weight: 2,
  },
  {
    id: 'salvage_catacomb_tick',
    name: 'Bone Tick',
    description: 'Feeds on ledgers, not blood.',
    sellPrice: 48,
    minMob: 23,
    weight: 2,
  },
  {
    id: 'salvage_stormglass',
    name: 'Stormglass Shard',
    description: 'Lightning frozen mid-fracture.',
    sellPrice: 52,
    minMob: 25,
    weight: 2,
  },
  {
    id: 'salvage_astral_quill',
    name: 'Astral Quill',
    description: 'Writes laws stars pretend not to know.',
    sellPrice: 58,
    minMob: 27,
    weight: 1,
  },
  {
    id: 'salvage_cloud_pearl',
    name: 'Cloud Pearl',
    description: 'Heavy for something named after vapor.',
    sellPrice: 62,
    minMob: 29,
    weight: 1,
  },
  {
    id: 'salvage_usurper_sigil',
    name: 'Fallen Crown Chip',
    description: 'Metal that remembers being obeyed.',
    sellPrice: 72,
    minMob: 35,
    weight: 1,
  },
